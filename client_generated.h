...
{0, MetaType_EntityRef, "EntityRef", "attachedBrainType", (u32) (&((SpawnerEntity*)0)->attachedBrainType), {}, sizeof(EntityRef),"invalid",0, 0, 0}, 
...
FieldDefinition fieldDefinitionOfUseLayout[] = 
 {
{0, MetaType_GameProperty, "GameProperty", "slotType", (u32) (&((UseLayout*)0)->slotType), {}, sizeof(GameProperty),"invalid",0, 0, "property"}, 
...
{0, MetaType_EntityRef, "EntityRef", "requiredEquippedType", (u32) (&((PossibleActionDefinition*)0)->requiredEquippedType), {}, sizeof(EntityRef),"invalid",0, 0, 0}, 
};
...
{MetaFlag_Pointer, MetaType_EntityRef, "EntityRef", "options", (u32) (&((CraftingComponent*)0)->options), {}, sizeof(EntityRef),"invalid",0, 0, 0}, 
...
{0, MetaType_u16, "u16", "essenceCount", (u32) (&((CommonEntityInitParams*)0)->essenceCount), {}, sizeof(u16),"invalid",0, 0, 0}, 
...
{0, MetaType_r32, "r32", "cooldown", (u32) (&((CommonEntityInitParams*)0)->cooldown), {}, sizeof(r32),"invalid",0, 0, 0}, 
};
...
{0, MetaType_EntityRef, "EntityRef", "hostileType", (u32) (&((BrainParams*)0)->hostileType), {}, sizeof(EntityRef),"invalid",0, 0, 0}, 
{0, MetaType_EntityRef, "EntityRef", "maintainDistanceType", (u32) (&((BrainParams*)0)->maintainDistanceType), {}, sizeof(EntityRef),"invalid",0, 0, 0}, 
{0, MetaType_EntityRef, "EntityRef", "scaryType", (u32) (&((BrainParams*)0)->scaryType), {}, sizeof(EntityRef),"invalid",0, 0, 0}, 
};
