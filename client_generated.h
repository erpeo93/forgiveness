...
InitFunc[Archetype_PortalArchetype] = InitPortalArchetype;InitFunc[Archetype_ObjectArchetype] = InitObjectArchetype;InitFunc[Archetype_GrassArchetype] = InitGrassArchetype;InitFunc[Archetype_PlantArchetype] = InitPlantArchetype;InitFunc[Archetype_RockArchetype] = InitRockArchetype;InitFunc[Archetype_AnimalArchetype] = InitAnimalArchetype;
;
...
{MetaFlag_Uneditable, MetaType_EntityRef, "EntityRef", "definitionID", (u32) (&((ServerEntityInitParams*)0)->definitionID), {}, sizeof(EntityRef),"invalid",0, 0, 0}, 
