...
{0, MetaType_GameProperty, "GameProperty", "underSeaLevelFluid", (u32) (&((tile_definition*)0)->underSeaLevelFluid), {}, sizeof(GameProperty),"invalid",0, 0, 0}, 
...
{0, MetaType_ArrayCounter, "ArrayCounter", "underwaterSoundCount", (u32) (&((tile_definition*)0)->underwaterSoundCount), {}, sizeof(ArrayCounter),"invalid","underwaterSounds", (u32)(&((tile_definition*)0)->underwaterSounds), 0}, 
{MetaFlag_Pointer, MetaType_SoundMappingDefinition, "SoundMappingDefinition", "underwaterSounds", (u32) (&((tile_definition*)0)->underwaterSounds), {}, sizeof(SoundMappingDefinition),"invalid",0, 0, 0}, 
};
...
{0, MetaType_u16, "u16", "componentCount", (u32) (&((CommonEntityInitParams*)0)->componentCount), {}, sizeof(u16),"invalid",0, 0, 0}, 
{0, MetaType_ArrayCounter, "ArrayCounter", "possibleComponentCount", (u32) (&((CommonEntityInitParams*)0)->possibleComponentCount), {}, sizeof(ArrayCounter),"invalid","possibleComponents", (u32)(&((CommonEntityInitParams*)0)->possibleComponents), 0}, 
{MetaFlag_Pointer, MetaType_EntityRef, "EntityRef", "possibleComponents", (u32) (&((CommonEntityInitParams*)0)->possibleComponents), {}, sizeof(EntityRef),"invalid",0, 0, 0}, 
...
{0, MetaType_b32, "b32", "hasVariant", (u32) (&((ClientEntityInitParams*)0)->hasVariant), {}, sizeof(b32),"invalid",0, 0, 0}, 
