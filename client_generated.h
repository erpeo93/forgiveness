...
InitFunc[Archetype_ObjectArchetype] = InitObjectArchetype;InitFunc[Archetype_GrassArchetype] = InitGrassArchetype;InitFunc[Archetype_PlantArchetype] = InitPlantArchetype;InitFunc[Archetype_RockArchetype] = InitRockArchetype;InitFunc[Archetype_AnimalArchetype] = InitAnimalArchetype;
;
...
{0, MetaType_ArrayCounter, "ArrayCounter", "possibleCraftingEffects", (u32) (&((CommonEntityInitParams*)0)->possibleCraftingEffects), {}, sizeof(ArrayCounter),"invalid","craftingEffects", (u32)(&((CommonEntityInitParams*)0)->craftingEffects), 0}, 
{MetaFlag_Pointer, MetaType_EffectBinding, "EffectBinding", "craftingEffects", (u32) (&((CommonEntityInitParams*)0)->craftingEffects), {}, sizeof(EffectBinding),"invalid",0, 0, 0}, 
};
